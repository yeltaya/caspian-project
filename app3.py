    ...
    def show_turkestan_dashboard(): 
        ...
        water_2025 = [
                ...
                {"Объект": "р. Бадам", "Класс": 3, "Характеристика": "Умеренно загрязненные", 
                 "Пригодность": "Ограничения для лососевых рыб. Для питья нужна очистка. Рекреация без ограничений.", "сульфаты"},
    ...
    def show_karagandy_dashboard(): 
        ...
        water_2025 = [
                ...
                {"Объект": "р. Шерубайнура", "Класс": 6, "Характеристика": "Высоко загрязненные", 
                 "Пригодность": "Только для тех. нужд. Крайне высокая нагрузка на экосистему.", "аммоний-ион, фосфор общий, фосфаты"}
            ]
