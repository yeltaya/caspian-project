...
with tabs[3]:
    ...
    with col3:
        ...
        # Описание ПЕРВОГО рисунка строго под ним
        st.markdown("""
        <div class="report-text">
            ...
            показатели увлажнения выше нормы. В отдельных точках зафиксированы 
            значения <span class="highlight-blue">более 150 мм</span>.
            <br><br>
            На севере, центре и юге преобладают ниже норм или умеренные уровни влаги – с минимальными 
            значениям <span class="highlight-blue"><25 мм</span>.
        </div>
        """, unsafe_allow_html=True)

    # --- ПРАВАЯ КОЛОНКА (Отклонение от нормы) ---
    with col4:
        ...
        # Описание ВТОРОГО рисунка строго под ним
        st.markdown("""
        <div class="report-text">
           <b>Превышение нормы:</b> восток (ВКО, Абай), север (Павлодарская, Акмолинская, СКО), горные районы Туркестанской области и восток Мангистауской области.
           <br><br>
           <b>Ниже нормы:</b> западные (ЗКО, Актюбинская, Атырауская), южные (Туркестанская, Жамбылская), юго-восточные (Алматинская, Жетісу) и центральные (Ұлытау, юг Костанайской) области. 
           Около нормы — в Кызылординской области.
        </div>
        """, unsafe_allow_html=True)
