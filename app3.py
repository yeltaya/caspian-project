        ...
        st.markdown("""
            <div style="background-color: #fdfaf5; padding: 20px; border-radius: 12px; border-left: 6px solid #8d6e63; margin-top: 0px;">
                ...
                <p style="font-size: 0.95rem; line-height: 1.4;">
                    <span style="font-weight: 800;">За последние 50 лет наблюдается слабая тенденция к увеличению годовых сумм атмосферных осадков на 2,5 мм/10 лет, в основном за счет осадков весеннего сезона. 
