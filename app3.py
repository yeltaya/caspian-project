...
# Пример расчёта средних значений (highlights) для Ертиса (сумма / 3)
    ...
    # РЯД 1
    with row1_col1:
        draw_basin_card("БАЛКАШ – АЛАКОЛЬСКИЙ БАССЕЙН", "В результате оценки изменения стока к 2050 г. ожидается увеличение относительно нормы (29,9 км3).", data_balhash, highlights_balhash)
    with row1_col2:
        draw_basin_card("ЕРТИССКИЙ БАССЕЙН", "В результате оценки изменения стока к 2050 г. ожидается увеличение относительно нормы (33.4 км3).", data_ertis, highlights_ertis)

    # РЯД 2
    with row2_col1:
        draw_basin_card("АРАЛО – СЫРДАРЬИНСКИЙ БАССЕЙН", "В результате оценки изменения стока к 2050 г. ожидается увеличение по «умеренно-жесткому» и «жесткому» сценарию, а по «мягкому» сценарию сокращение относительно нормы (21,4 км3).", data_aral, highlights_aral)
    with row2_col2:
        draw_basin_card("ЖАЙЫК – КАСПИЙСКИЙ БАССЕЙН", "В результате оценки изменения стока к 2050 г. ожидается увеличение относительно нормы (12.0 км3).", data_zhayik, highlights_zhayik)

    # РЯД 3
    with row3_col1:
        draw_basin_card("ШУ – ТАЛАССКИЙ БАССЕЙН", "В результате оценки изменения стока к 2050 г. ожидается увеличение относительно нормы (4,12 км3).", data_shu_talas, highlights_shu)
    with row3_col2:
        draw_basin_card("ТОБЫЛ – ТОРГАЙСКИЙ БАССЕЙН", "В результате оценки изменения стока к 2050 г. ожидается увеличение относительно нормы (1,67 км3).", data_obyl_torgay, highlights_torgay)

    # РЯД 4 (одиночный бассейн)
    with row4_col1:
        draw_basin_card("НУРА-САРЫСУЙСКИЙ БАССЕЙН", "В результате оценки изменения стока к 2050 г. ожидается увеличение относительно нормы (1,16 км3).", data_nura_sarysu, highlights_nura)
    # РЯД 4 (одиночный бассейн)
    with row4_col2:
        draw_basin_card("ЕСИЛЬСКИЙ БАССЕЙН", "В результате оценки изменения стока к 2050 г. ожидается увеличение относительно нормы (2,29 км3).", data_esil, highlights_esil)
