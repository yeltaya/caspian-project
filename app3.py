...
#АГРОКЛИМАТИЧЕСИК ЗОНЫ
    ...
    def s_footer():
        st.markdown("---") # Тонкая линия-разделитель
        ...
        .footer {
            ...
            color: #555;
            text-align: center;
            padding: 10px 0px; /* Уменьшили вертикальный отступ */
            font-size: 13px;   /* Уменьшили шрифт */
            line-height: 1.2;  /* Уплотнили строки */
        ...
        <div class="footer">
            <div class="footer-content">
                <div>
                    <strong>🇰🇿 РГП «Казгидромет»</strong> | Национальная служба
                </div>
                <div>
                    📞 +7 (7172) 79-83-94 | 
                    <a href="mailto:info@kazhydromet.kz">info@kazhydromet.kz</a>
                </div>
                <div>
                    🔗 <a href="https://www.kazhydromet.kz" target="_blank">kazhydromet.kz</a>
                </div>
            </div>
            <p style="margin-top: 5px; font-size: 11px; color: #999;">
                © 2026 Проект мониторинга Каспийского региона
            </p>
        </div>
        """
    ...
    if __name__ == "__main__":
        ...
        VXB_FULL_DATA = {
            ...
            "Жайык-Каспийский ВХБ": {
                ...
                "гп_кол": "52",
                "рек_всего": "200-240",
                "артерия": "Река Жайык - трансграничная река бассейна Каспийского моря с преимущественно снеговым типом питания. Характеризуется выраженной весенней половодной волной и высокой рыбохозяйственной значимостью (включая нерестовые пути осетровых). Имеет важное значение как природная географическая граница между Европой и Азией.",
